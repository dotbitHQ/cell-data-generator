...
fn gen_config_cell_main() -> String {
    ...
    let das_lock_out_point_table = DasLockOutPointTable::new_builder()
        .ckb_signall(out_point!([19, 115, 219, 137, 253, 44, 127, 241, 97, 125, 79, 214, 116, 14, 145, 97, 105, 99, 28, 90, 182, 201, 153, 87, 134, 100, 80, 113, 171, 25, 184, 34],
            0
        ))
        ...
        .eth(out_point!([67, 255, 193, 177, 20, 163, 162, 187, 60, 148, 242, 196, 197, 90, 110, 102, 109, 28, 105, 216, 57, 74, 244, 160, 53, 133, 129, 87, 174, 191, 199, 196],
            0
        ))
        .tron(out_point!([23, 217, 146, 205, 44, 122, 170, 41, 140, 93, 63, 124, 54, 87, 9, 244, 172, 123, 37, 196, 74, 165, 214, 24, 182, 36, 92, 252, 74, 15, 3, 82],
            0
        ))
        .build();

    let entity = ConfigCellMain::new_builder()
        // CAREFUL Switch this to turn system on/off
