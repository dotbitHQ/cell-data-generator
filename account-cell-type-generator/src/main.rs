...
fn main() {
    ...
    let message: Vec<u8> = vec![
        30, 252, 99, 64, 227, 240, 82, 13, 3, 164, 175, 111, 13, 217, 225, 82, 69, 52, 130, 85,
        131, 88, 229, 199, 155, 146, 129, 38, 84, 19, 109, 8, 184, 180, 171, 63, 69, 73, 42, 137,
        66, 186, 6, 89, 56, 213, 240, 101, 226, 149, 151, 174, 178, 137, 65, 239, 230, 110, 44, 13,
        66, 13, 26, 66, 23, 72, 163, 142, 230, 249, 32, 7, 107, 168, 127, 35, 95, 124, 151, 19,
        126, 76, 244, 91, 224, 175, 88, 181, 245, 83, 85, 188, 9, 150, 231, 208,
    ];
    let cell_data = [
